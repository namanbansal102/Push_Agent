...
- Subscription-style recurring transfers
...
```
"Get details of transaction 0xABC...DEF"
"Show my recent transactions"
"Track my payment to John"
```
...
```
"Generate and deploy an ERC20 token contract"
"Deploy a smart contract for [your use case]"
...
- **Token Transfers**: `"Show all transfers of token 0xABC..."`
- **Internal Transactions**: `"Get internal txs for address 0xDEF..."`
- **Market Charts**: `"Show market chart for the last 7 days"`
- **Token Holders**: `"List top holders of token XYZ"`
- **Address Analytics**: `"Show all transactions from my wallet"`
- **NFT Tracking**: `"Display my NFT collection"`

---

### 📦 Digital Asset Storage

Store and manage your digital assets on-chain:

#### **Save Assets**
```
"Store this image with description 'Company Logo'"
"Save my document: Q&A report 2024"
"Upload my NFT artwork"
```

#### **Retrieve Assets**
```
"Show all my stored assets"
"Find assets containing 'invoice'"
"Get my stored documents"
```

---

### 💱 Token Exchange & Market Data
...
#### **Crypto Swaps** *(Coming with Mainnet)*
- Exchange between different cryptocurrencies
- Get real-time exchange rates
- Track swap status
- Supported currencies across multiple chains

---

### 📖 Address Book Management

Never lose track of your contacts:

```
"Save Alice's address as alice.eth"
"Add Bob to my address book: 0xBOB...123"
"What's John's wallet address?"
"Fetch address for employee Sarah"
```
...
### **For Business Owners**
- Pay 100+ employees automatically every month
- Send performance bonuses on specific dates
- Distribute profit shares quarterly
...
- Gift crypto on special occasions
...
### Asset Management
```
"Store this document: 'Q4 Financial Report'"
"Show all my stored assets"
"Find assets with 'invoice' in description"
```
